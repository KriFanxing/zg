...
const App: React.FC = () => {
  ...
  return (
    <div className="app-root">
      ...
      {/* ── Collapsible Panel ── */}
      <div className={`cp-root ${panelOpen ? 'cp-open' : 'cp-closed'}`}>
        <button className="cp-toggle" onClick={() => setPanelOpen(o => !o)}>
          {panelOpen ? '▶' : '◀'} 📝 任务
        </button>
        ...
        <div className="cp-inner">
          ...
          <div className="cp-tabs">
            <button className={`cp-tab ${panelTab === 'task' ? 'active' : ''}`} onClick={() => setPanelTab('task')}>📌 任务</button>
            <button className={`cp-tab ${panelTab === 'history' ? 'active' : ''}`} onClick={() => setPanelTab('history')}>📜 历史</button>
          </div>
          ...
          {panelTab === 'task' && (
            <div className="cp-section">
              ...
              <button className="cp-btn-reset" onClick={resetAll}>🔄 重置全员</button>
            </div>
          )}
